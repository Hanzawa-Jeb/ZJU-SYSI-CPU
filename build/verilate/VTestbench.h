...
class alignas(VL_CACHE_LINE_BYTES) VTestbench VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    VTestbench_CorePack* const __PVT__CorePack;
    VTestbench_Mem_ift* const __PVT__Testbench__DOT__dut__DOT__imem_ift;
    VTestbench_Mem_ift* const __PVT__Testbench__DOT__dut__DOT__dmem_ift;
