...
VTestbench::VTestbench(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , __PVT__CorePack{vlSymsp->TOP.__PVT__CorePack}
    , __PVT__Testbench__DOT__dut__DOT__imem_ift{vlSymsp->TOP.__PVT__Testbench__DOT__dut__DOT__imem_ift}
    , __PVT__Testbench__DOT__dut__DOT__dmem_ift{vlSymsp->TOP.__PVT__Testbench__DOT__dut__DOT__dmem_ift}
    , rootp{&(vlSymsp->TOP)}
{
